...
export class AuthController {
  ...
  async signUp(@Body() signUpDto: SignUpLocalDto): Promise<TokenResponseDto> {
  ...
  async signIn(@Body() signInDto: SignInLocalDto): Promise<TokenResponseDto> {
  ...
  refresh(@RequestUser() user: ActiveUser): TokenResponseDto {
